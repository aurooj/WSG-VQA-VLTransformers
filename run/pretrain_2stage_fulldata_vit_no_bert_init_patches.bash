...
name=lxmert_pretrain_itm_mlm_qa_552_patches_x_allqa_vit7_no_bert_init_stage_1
...
# The name of experiment
name=lxmert_pretrain_itm_mlm_qa_552_patches_x_allqa_vit7_no_bert_init_stage_2
...
CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
   ...
   --loadLXMERT snap/pretrain/lxmert_pretrain_itm_mlm_qa_552_patches_x_allqa_vit7_no_bert_init_stage_1/BEST_EVAL_LOSS \
