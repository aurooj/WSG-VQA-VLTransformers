...
name=16caps_itm_mlm_qa_552_grid_x_allqa_no_init_stage_1
...
# The name of experiment
name=16caps_itm_mlm_qa_552_grid_x_allqa_no_init_stage_2
...
CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
   ...
   --loadLXMERT snap/pretrain/16caps_itm_mlm_qa_552_grid_x_allqa_no_init_stage_1/BEST_EVAL_LOSS \
