...
name=lxmert_pretrain_itm_mlm_qa_552_patches_x_selfcross_allqa_vit7_no_bert_init_stage_1
...
# The name of experiment
name=lxmert_pretrain_itm_mlm_qa_552_patches_x_selfcross_allqa_vit7_no_bert_init_stage_2
...
CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
   ...
   --loadLXMERT snap/pretrain/lxmert_pretrain_itm_mlm_qa_552_patches_x_selfcross_allqa_vit7_no_bert_init_stage_1/BEST_EVAL_LOSS \
    --skipConnection --crossAttn --crossAttnType cross_self --freezeWeights\
    --batchSize 1024 --optim bert --lr 1e-4 --epochs 10 \
    --vitInit --startIndex 7 \
    --patches --tqdm --output $output ${@:2}
