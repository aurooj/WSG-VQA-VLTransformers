...
name=48caps_itm_mlm_qa_552_grid_x_allqa_no_init_stage_1
...
CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
    ...
    --NUM_PRIM_CAPS 48 --NUM_VIS_CAPS 48 \
    --tqdm --output $output ${@:2}



# The name of experiment
name=48caps_itm_mlm_qa_552_grid_x_allqa_no_init_stage_2
...
CUDA_VISIBLE_DEVICES=$1 PYTHONPATH=$PYTHONPATH:./src \
   ...
   --loadLXMERT snap/pretrain/48caps_itm_mlm_qa_552_grid_x_allqa_no_init_stage_1/BEST_EVAL_LOSS \
